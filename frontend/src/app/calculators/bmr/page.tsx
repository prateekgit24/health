...
export default function BmrPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-12 sm:px-6">
      <h1 className="text-4xl font-semibold text-primary-50">BMR Calculator</h1>
      <p className="mt-3 text-primary-100/80">Uses the Mifflin-St Jeor equation.</p>
      ...
      <div className="mt-8 rounded-2xl border border-primary-200/15 bg-primary-950/25 p-6">
        ...
        <p className="mt-6 text-xl font-semibold text-secondary-200">Estimated BMR: {Math.round(bmr)} kcal/day</p>
      </div>
    </main>
  );
}
