...
export default function BodyFatPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-12 sm:px-6">
      <h1 className="text-4xl font-semibold text-emerald-50">Body Fat Calculator</h1>
      ...
      <div className="mt-8 rounded-2xl border border-emerald-200/15 bg-emerald-950/25 p-6">
        ...
        <label className="mt-5 block text-sm font-medium text-emerald-100/85">Waist (cm)</label>
        <input
          type="number"
          value={waist}
        ...
        <label className="mt-5 block text-sm font-medium text-emerald-100/85">Neck (cm)</label>
        <input
          type="number"
          value={neck}
        ...
        {sex === "female" ? (
          <>
            <label className="mt-5 block text-sm font-medium text-emerald-100/85">Hip (cm)</label>
            <input
              type="number"
              value={hip}
