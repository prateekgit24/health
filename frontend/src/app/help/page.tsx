  ...
  return (
    <main className="mx-auto w-full max-w-4xl px-4 py-12 sm:px-6">
      <section className="app-surface rounded-2xl p-6">
        <h1 className="text-3xl font-semibold text-emerald-100">Help</h1>
        <p className="mt-3 text-sm text-emerald-100/85">Quick start guide:</p>
        <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm text-emerald-100/90">
        ...
        <div className="mt-5 rounded-xl border border-emerald-200/20 bg-emerald-950/35 p-4">
          <h2 className="text-lg font-semibold text-amber-200">Troubleshooting</h2>
