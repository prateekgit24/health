  ...
  return (
    <main className="mx-auto w-full max-w-4xl px-4 py-12 sm:px-6">
      <section className="app-surface rounded-2xl p-6">
        <h1 className="text-3xl font-semibold text-primary-100">Terms and Conditions</h1>
        <p className="mt-3 text-sm text-primary-100/85">Last updated: April 5, 2026</p>
        <div className="mt-4 space-y-3 text-sm text-primary-100/90">
          <p>
